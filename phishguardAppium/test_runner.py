...
# Ensure imports resolve from phishguardAppium and test_suite/appium
sys.path.append(os.path.join(os.path.dirname(__file__), "..", "test_suite", "appium"))
...
print("Target APK: app/build/outputs/apk/debug/app-debug.apk")
